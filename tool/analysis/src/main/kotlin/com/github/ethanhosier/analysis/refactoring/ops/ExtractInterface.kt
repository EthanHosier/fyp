...
data class ExtractInterfaceRequest(
    val projectRoot: Path,
    val sourceFolders: List<String>,
    val classpathJars: List<Path>,
    val sourceTypeFqn: String,
    val newInterfaceName: String,
    // Method names unambiguous on [sourceTypeFqn].
...
fun RefactoringClient.extractInterface(req: ExtractInterfaceRequest): RefactoringOutcome =
    invokeOnBundle(
        "extractInterface",
        paramTypes,
        arrayOf(
