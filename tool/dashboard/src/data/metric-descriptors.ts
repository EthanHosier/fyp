...
export const METRIC_DESCRIPTORS: Record<MetricId, MetricDescriptor> = {
  cognitive: {
    summary:
      "How hard the code is to follow at a glance. Lower is better.",
  ...
  readability: {
    summary:
      "How approachable the code looks to a new reader. Higher is better.",
    formula:
  ...
  duplication: {
    summary:
      "Share of the codebase that is copy-pasted from somewhere else. Lower is better.",
  ...
  smells: {
    summary:
      "Number of suspicious patterns flagged across the project. Lower is better.",
  ...
  coupling: {
    summary:
      "How entangled the most-connected classes are with the rest of the system. Lower is better.",
  ...
  cohesion: {
    summary:
      "How focused each class is — do its methods belong together? Higher is better.",
