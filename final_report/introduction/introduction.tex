...
The work does not attempt to enumerate every possible refactoring sequence or prove that a generated trajectory is globally optimal. The analysis component instead looks for a plausible higher-scoring reference path between the same start and end states, then uses that path to explain the developer's observed process.
